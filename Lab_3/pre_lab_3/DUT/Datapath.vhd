...
generic( Dwidth: integer:=16;
  ...
  port (
    ...
    shl_s  : out std_logic;   --OPC = "0101"   shift left
...
-------------------------------------------------------------------------------------
  ...
  DTCM_rd_addr <= DTCM_tb_addr_out when TBactive = '1' else BUS_wire(Awidth-1 downto 0);
...
PC_next <= (others => '0')                              when PCsel = "00" else
  ...
  shl_s  <= '1' when IR_reg(15 downto 12) = "0101" else '0';
  ...
  is_rtype <= '1' when (IR_reg(15 downto 12) = "0000" or   -- add
                        ...
                        IR_reg(15 downto 12) = "0100" or    -- xor
                        IR_reg(15 downto 12) = "0101"     )--shl
                 else '0';
-----------------------------------------------------------------------------------
