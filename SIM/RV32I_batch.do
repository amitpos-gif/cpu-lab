# ============================================================================
#  LAB5 - RV32IM Pipeline - BATCH run (compile + simulate + export DTCM)
#  Usage:  vsim -c -do RV32I_batch.do
# ============================================================================

set SRC "C:/Users/amitp/OneDrive/Desktop/Comp_Lab/Lab_5/DUT/RV32IM PIPLINE"
set OUT "C:/Users/amitp/OneDrive/Desktop/Comp_Lab/Lab_5/BENCHMARKS/test1/RV32IM/RV32IM PIPELINE/man_compiled/output/MODELSIM"
...
echo "=== DTCM exported to $OUT/DTCM_PIPLINE.mem ==="
quit -f
