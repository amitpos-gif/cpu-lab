...
#  list mems:     mem list
#
#  export DTCM (test1 man_compiled):
#  mem save -o {C:/Users/amitp/OneDrive/Desktop/Comp_Lab/Lab_5/BENCHMARKS/test1/RV32IM/RV32IM PIPELINE/man_compiled/output/MODELSIM/DTCM_PIPLINE.mem} -f mti -data hex -addr hex -startaddress 0 -endaddress 2047 -wordsperline 1 sim:/tb_RV32I/CORE/DMEM_inst/data_memory/MEMORY/m_mem_data_a
#
#  export ITCM (optional):
#  mem save -o {C:/Users/amitp/OneDrive/Desktop/Comp_Lab/Lab_5/BENCHMARKS/test1/RV32IM/RV32IM PIPELINE/man_compiled/output/MODELSIM/ITCM_PIPLINE.mem} -f mti -data hex -addr hex -startaddress 0 -endaddress 2047 -wordsperline 1 sim:/tb_RV32I/CORE/IFETCH_inst/inst_memory/MEMORY/m_mem_data_a
# ============================================================================
